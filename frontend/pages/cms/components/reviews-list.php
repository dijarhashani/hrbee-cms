...
<script>
    document.addEventListener("DOMContentLoaded", function() {
            ...
            fetch(`backend/reviews-list.php`)
                    ...
                    data.forEach(trajner => {
                        ...
                        ap_item.innerHTML = `
                            <div class="trajner-item"> 
                                <div class="t-picture">
                                    <div style='background:url("frontend/uploads/reviews/${trajner.photo_path}")' class="t-photo"></div>
                                </div>
                                <div class="t-name">
                                    <h3>Emri dhe Mbiemri</h3>
                                    <h1>${trajner.name || 'N/A'} </h1>
                                </div>
                                <div class="t-position">
                                    <h3>Position</h3>
                                    <h1>${trajner.position || 'N/A'}</h1>
                                </div>
                                <div class="update-btn">
                                    <a href="dashboard-reviews-edit?id=${trajner.id || 'N/A'}">Ndrysho</a>
                                </div>
                            </div>
                        `;
